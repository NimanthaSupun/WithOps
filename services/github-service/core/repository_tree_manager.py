...
class RepositoryTreeManager:
    ...
    async def get_repository_tree(
        ...
        try:
            ...
            if tree:
                ...
                logger.info(f"No repository tree found for org {organization_id}, user {user_id}")
                return {
                    "success": True,
                    "data": [],
                    "metadata": {
    ...
    async def save_repository_tree(
        ...
        Args:
            organization_id: Organization ID
            user_id: User ID saving the tree
        ...
        try:
            ...
            if tree:
                ...
                logger.info(f"Updated repository tree {tree.id} for org {organization_id}")
                ...
                self.db.add(tree)
                logger.info(f"Created new repository tree for org {organization_id}")
    ...
    async def delete_repository_tree(
        ...
        try:
            ...
            if tree:
                ...
                logger.info(f"Deleted repository tree {tree.id} for org {organization_id}")
