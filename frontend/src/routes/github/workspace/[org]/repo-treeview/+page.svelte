<script>
    ...
    async function startUnifiedAnalysis() {
        ...
        try {
            ...
            const response = await fetch('http://localhost:8000/api/workspace-intelligence/analyze-workspace-unified', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`
    ...
    <div class="main-layout">
        ...
        <aside class="left-sidebar">
            ...
            <div class="sidebar-actions">
                <button 
                    onclick={checkAndNavigateToIntelligence}
                                                    ...
                                                    <div class="nested-folder-item">
                                                        <div class="nested-folder-header">
                                                            <button 
                                                                ...
                                                                aria-label={expandedNodes.has(child.id) ? 'Collapse folder' : 'Expand folder'}
                                                            >
                                                                ...
                                                                {#each child.children as nestedChild}
                                                                    {#if nestedChild.type === 'folder'}
                                                                        ...
                                                                        <div class="nested-folder-item deeper">
                                                                            <div class="nested-folder-header">
                                                                                <button 
                                                                                    onclick={() => toggleNode(nestedChild)}
                                                                                    class="expand-button small"
                                                                                >
                                                                                ...
                                                                                <span class="item-count small">({countItemsInNode(nestedChild)} items)</span>
                                                                                <div class="folder-actions">
                                                                                    <button onclick={() => openAnalyzeFolderModal(nestedChild)} class="action-icon analyze small" title="Analyze" aria-label="Analyze folder maturity">
                                                                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                                                                        </svg>
                                                                                    </button>
                                                                                    <button onclick={() => startEditing(nestedChild)} class="action-icon small" title="Rename" aria-label="Rename folder">
                                                                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                                                        </svg>
                                                                                    </button>
                                                                                    <button onclick={() => openNewFolderModal(nestedChild)} class="action-icon small" title="Add subfolder" aria-label="Add subfolder">
                                                                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                                                                        </svg>
                                                                                    </button>
                                                                                    <button onclick={() => deleteNode(nestedChild)} class="action-icon delete small" title="Delete" aria-label="Delete folder">
                                                                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                                                        </svg>
                                                                                    </button>
                                                                                        ...
                                                                                        {#if deepChild.type === 'repository'}
                                                                                            <div class="repo-item">
                                                                                                ...
                                                                                                {#if deepChild.children}
                                                                                                    <span class="workflow-count">({deepChild.children.length} workflows)</span>
                                                                                                {/if}
                                                                                                <div class="repo-actions">
                                                                                                    {#if deepChild.metadata?.html_url}
                                                                                                        <a href={deepChild.metadata.html_url} target="_blank" class="action-icon" title="Open in GitHub" aria-label="Open repository in GitHub">
                                                                                                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                                                                                                            </svg>
                                                                                                        </a>
                                                                                                    {/if}
                                                                                                    <button onclick={() => deleteNode(deepChild)} class="action-icon delete" title="Remove" aria-label="Remove repository from folder">
                                                                                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                    ...
                                                                    {:else if nestedChild.type === 'repository'}
                                                                        <div class="repo-item">
                                                                            ...
                                                                            {#if nestedChild.children}
                                                                                <span class="workflow-count">({nestedChild.children.length} workflows)</span>
                                                                            {/if}
...
{#if showAnalyzeFolderModal}
    <div class="modal-overlay">
        <div class="modal">
            <div class="modal-header">
                <h3 style="color: white;">Analyze Folder</h3>
                ...
                {#if folderToAnalyze}
                    <div class="folder-info">
                        <div class="info-row">
                            ...
                            <div class="info-text">
                                <span class="label" style="color: white;">Folder Name:</span>
                                <span class="value" style="color: white;">{folderToAnalyze.name}</span>
                            </div>
                        </div>
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-text">
                                <span class="label" style="color: white;">Path:</span>
                                <span class="value" style="color: white;">{getFolderPath(folderToAnalyze)}</span>
                            </div>
                        </div>
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-text">
                                <span class="label" style="color: white;">Repositories:</span>
                                <span class="value badge" style="color: white;">{countRepositoriesInFolder(folderToAnalyze)}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="options">
                        <label class="checkbox-label">
                            ...
                            />
                            <span style="color: white;" >Include all subfolders and their repositories</span>
                        </label>
                    </div>
                    ...
                    {#if !analyzingFolder}
                        <div class="info-notice">
                            ...
                            <span style="color: white;">This will analyze {includeSubfolders ? 'this folder and all subfolders' : 'only repositories directly in this folder'} using the OWASP DSOMM framework.</span>
                        </div>
                    {/if}
                {/if}
            </div>
            ...
            <div class="modal-footer">
                ...
                >
                    {#if analyzingFolder}
                        <div class="loading-spinner small"></div>
                        <span style="color: white;">Analyzing...</span>
                    {:else}
                        <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                        <span style="color: white;">Start Analysis</span>
                    {/if}
                </button>
            </div>
        </div>
...
{#if showAnalysisOptionsModal}
    <div class="modal-backdrop" onclick={closeAnalysisOptionsModal} onkeydown={(e) => e.key === 'Escape' && closeAnalysisOptionsModal()} role="button" tabindex="0">
        <div class="modal-container analysis-options-modal" onclick={(e) => e.stopPropagation()} onkeydown={(e) => e.stopPropagation()} role="dialog" tabindex="-1">
            <div class="modal-header">
            ...
            <div class="modal-body analysis-options-body">
                ...
                <div class="analysis-option {analysisMode === 'unified' ? 'selected' : ''}" onclick={() => analysisMode = 'unified'} onkeydown={(e) => (e.key === 'Enter' || e.key === ' ') && (analysisMode = 'unified')} role="button" tabindex="0">
                    <div class="option-header">
                        <input type="radio" name="analysis-mode" checked={analysisMode === 'unified'} />
                        <div class="option-title-wrapper">
                            <span class="option-name" style="color: white;">Unified Workspace Analysis</span>
                            <span class="recommended-badge">Recommended</span>
                        </div>
                    </div>

                    <p class="option-description" style="color: white;">
                        Analyze all folders and repositories in one comprehensive assessment. Perfect for executive dashboards and organization-wide visibility.
                    </p>

                    <ul class="option-benefits" style="color: white;">
                    ...
                    <div class="option-stats" style="color: white;">
                        <span class="stat">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="analysis-option {analysisMode === 'folder' ? 'selected' : ''}" onclick={() => analysisMode = 'folder'} onkeydown={(e) => (e.key === 'Enter' || e.key === ' ') && (analysisMode = 'folder')} role="button" tabindex="0">
                    <div class="option-header">
                        <input type="radio" name="analysis-mode" checked={analysisMode === 'folder'} />
                        <div class="option-title-wrapper">
                            <span class="option-name" style="color: white;">Folder-Specific Analysis</span>
                        </div>
                    </div>

                    <p class="option-description" style="color: white;">
                        Analyze a specific team or product folder for focused assessment. Ideal for team retrospectives and targeted improvements.
                    </p>
                    ...
                    {#if analysisMode === 'folder'}
                        <div class="folder-selector">
                            <label for="folder-analysis-select" style="color: white;">Select folder to analyze:</label>
                            <select id="folder-analysis-select" bind:value={folderForFolderAnalysis} class="folder-dropdown">
                            ...
                            <label class="checkbox-label">
                                <input type="checkbox" bind:checked={includeSubfoldersInModal} style="color: white;" />
            ...
            <div class="modal-footer">
                <button onclick={closeAnalysisOptionsModal} class="btn-secondary" style="color: white;">
                    Cancel
                </button>
                {#if analysisMode === 'unified'}
                    <button onclick={startUnifiedAnalysis} class="btn-primary">
                        ...
                        <span style="color: white;">Start Unified Analysis</span>
                    </button>
                {:else}
                    <button onclick={startFolderAnalysisFromModal} disabled={!folderForFolderAnalysis} class="btn-primary">
                        <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z" />
                        </svg>
                        <span style="color: white;">Start Folder Analysis</span>
                    </button>
                {/if}
            </div>
        </div>
    ...
    <div class="modal-backdrop" onclick={closeAnalysisOptionsModal} onkeydown={(e) => e.key === 'Escape' && closeAnalysisOptionsModal()} role="button" tabindex="0">
        <div class="modal-container analysis-options-modal" onclick={(e) => e.stopPropagation()} onkeydown={(e) => e.stopPropagation()} role="dialog" tabindex="-1">
            ...
            <div class="modal-body analysis-options-body">
                ...
                <div class="analysis-option {analysisMode === 'unified' ? 'selected' : ''}" onclick={() => analysisMode = 'unified'} onkeydown={(e) => (e.key === 'Enter' || e.key === ' ') && (analysisMode = 'unified')} role="button" tabindex="0">
                    <div class="option-header">
                        <input type="radio" name="analysis-mode" checked={analysisMode === 'unified'} onchange={() => analysisMode = 'unified'} />
                        <div class="option-title-wrapper">
                    ...
                    {#if analysisMode === 'unified'}
                        <button class="btn-primary" onclick={startUnifiedAnalysis} style="margin-top: 1rem; width: 100%;">
                            <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                            </svg>
                            <span style="color: white;">Start Unified Analysis</span>
                ...
                <div class="analysis-option {analysisMode === 'folder' ? 'selected' : ''}" onclick={() => analysisMode = 'folder'} onkeydown={(e) => (e.key === 'Enter' || e.key === ' ') && (analysisMode = 'folder')} role="button" tabindex="0">
                    <div class="option-header">
                        <input type="radio" name="analysis-mode" checked={analysisMode === 'folder'} onchange={() => analysisMode = 'folder'} />
                        <div class="option-title-wrapper">
                    ...
                    {#if analysisMode === 'folder'}
                        <div class="folder-selector">
                            <label for="folder-analysis-select-2" style="color: white;">Select folder to analyze:</label>
                            <select id="folder-analysis-select-2" bind:value={folderForFolderAnalysis} class="folder-dropdown">
                                <option value={null}>Choose a folder...</option>
                                {#each getFlattenedFolders(repoTreeData) as folder}
                                    <option value={folder}>
                                        {'  '.repeat(folder.depth)}📁 {folder.name} ({countRepositoriesInFolder(folder)} repos)
                                    </option>
                                {/each}
                            </select>
...
<style>
    ...
    .folder-card {
        ...
        padding: 1.5rem;
        transition: all 0.3s ease;
        max-height: 600px; /* Limit card height */
        display: flex;
        flex-direction: column;
        overflow: hidden;
    }
