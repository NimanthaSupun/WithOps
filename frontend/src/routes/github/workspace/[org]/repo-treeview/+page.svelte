        ...
        <header class="mb-8">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    ...
                    <button 
                        on:click={() => goto(`/github/workspace/${orgName}/intelligence`)}
                        class="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 font-medium flex items-center space-x-2"
                    >
