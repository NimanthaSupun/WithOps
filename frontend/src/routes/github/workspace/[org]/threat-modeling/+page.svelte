<script>
    ...
    async function deleteThreatModel() {
        ...
        try {
            ...
            showNotification(`Threat model "${deletedModelName}" has been deleted successfully.`, 'success');
        ...
        <main class="main-content">
            ...
            {:else if error}
                ...
                <div class="error-state">
                    ...
                    <button onclick={loadThreatModels} class="retry-button">
                        Try Again
                    </button>
                </div>
            {:else if threatModels.length === 0}
                ...
                <div class="empty-state">
                    ...
                    <p class="empty-description">Get started by creating your first threat model or importing an existing one.</p>
            ...
            {:else}
                ...
                <div class="content-header">
                    ...
                    <span class="content-count">{threatModels.length} {threatModels.length === 1 ? 'model' : 'models'}</span>
                </div>
        ...
        >
            <div class="modal-header">
                <div>
                    ...
                    <p class="modal-subtitle" style="color: rgba(255, 255, 255, 0.8) !important;">Start your security threat analysis</p>
                </div>
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="modelName" class="form-label" style="color: #FFFFFF !important;">Model Name *</label>
                    <input
                        id="modelName"
                        type="text"
                ...
                <div class="form-group">
                    <label for="modelDescription" class="form-label" style="color: #FFFFFF !important;">Description</label>
                    <textarea
                        id="modelDescription"
                ...
                <div class="form-group">
                    <label for="methodology" class="form-label" style="color: #FFFFFF !important;">Methodology</label>
                    <select
                        id="methodology"
                        bind:value={newModelMethodology}
                        class="form-input"
                        style={darkMode ? 'background: #FFFFFF !important; color: #000000 !important;' : 'background: #FFFFFF !important; color: #000000 !important;'}
                    >
                ...
                <div class="info-box">
                    ...
                    <p class="info-text">
                        After creating the model, you'll be able to design your system architecture and identify potential threats.
                    </p>
                </div>
            </div>
        ...
        >
            <div class="modal-header">
                <div>
                    ...
                    <p class="modal-subtitle" style="color: rgba(255, 255, 255, 0.8) !important;">This action cannot be undone</p>
                </div>
...
<style>
    ...
    .empty-icon {
        width: 120px;
        height: 120px;
        background: linear-gradient(135deg, rgba(74, 158, 255, 0.1) 0%, rgba(255, 139, 74, 0.05) 100%);
        border-radius: 50%;
        display: flex;
        align-items: center;
        justify-content: center;
