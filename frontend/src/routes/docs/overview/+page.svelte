...
<div class="getting-started {visible ? 'visible' : ''}">
	...
	<p class="page-subtitle">
		A deep dive into the WithOps microservices architecture, event-driven design, and observability
		stack.
	</p>
	...
	<div class="prose">
		...
		<p>
			WithOps is built on a modern, distributed microservices architecture designed for extreme
			isolation, scalability, and resilience.
		</p>
		<ul>
			<li>
				<strong>Service Isolation:</strong> Each microservice owns its business domain and database schema.
			</li>
			<li>
				<strong>Event-Driven Communication:</strong> Services use a Redis Pub/Sub event bus for loose
				coupling.
			</li>
			<li>
				<strong>API Gateway Pattern:</strong> A Kong Gateway provides a single, secure entry point for
				all client requests.
			</li>
			<li>
				<strong>Observability First:</strong> Built-in support for distributed tracing (Jaeger), metrics
				(Prometheus), and centralized logging (Loki).
			</li>
		</ul>
		...
		<p>
			The platform consists of 9 specialized services, each handling a specific part of the
			DevSecOps lifecycle.
		</p>
		...
		<div class="service-grid">
			<div class="service-item">
				...
				<div>
					...
					<p>
						Real-time WebSocket synchronization engine using Redis Pub/Sub for live platform
						updates.
					</p>
				</div>
			</div>
			<div class="service-item">
				...
				<div>
					...
					<p>
						Core reasoning engine interfacing with GPT-4, Claude, and local Ollama for code
						analysis.
					</p>
				</div>
			</div>
			...
			<div class="service-item">
				...
				<div>
					...
					<p>
						CI/CD pipeline manager orchestrating SAST, dependency auditing, and secret scanning.
					</p>
				</div>
			</div>
			<div class="service-item">
				...
				<div>
					...
					<p>
						Retrieval-Augmented Generation engine using Vector Search (Qdrant) for security chat.
					</p>
				</div>
			</div>
		</div>
