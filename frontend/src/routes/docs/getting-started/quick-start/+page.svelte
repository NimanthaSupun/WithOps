...
<svelte:head>
	...
	<meta name="description" content="Get WithOps running in under 5 minutes. Choose between cloud-hosted or self-hosted deployment with Docker Compose." />
</svelte:head>
...
<div class="getting-started {visible ? 'visible' : ''}">
	...
	<p class="page-subtitle">
		Get the platform running in under five minutes — choose cloud-hosted for instant access or self-hosted for full control.
	</p>
	...
	<p class="prose-text">
		WithOps supports two deployment modes. Pick the one that suits your needs — you can always switch later.
	</p>

	<div class="deploy-tabs">
		<button class="deploy-tab {activeTab === 'cloud' ? 'active' : ''}" onclick={() => (activeTab = 'cloud')}>
			<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
				<path d="M18 10h-1.26A8 8 0 109 20h9a5 5 0 000-10z" />
			</svg>
			Cloud Hosted
		</button>
		<button class="deploy-tab {activeTab === 'self' ? 'active' : ''}" onclick={() => (activeTab = 'self')}>
			<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
		...
		<div class="tab-panel" id="cloud-setup">
			<div class="callout info">
				...
				<div class="callout-content">
					...
					<p>Cloud-hosted requires no infrastructure setup. You'll be scanning repositories within 2 minutes.</p>
				</div>
			</div>
			...
			<div class="steps">
				<div class="step-card">
					...
					<div class="step-body">
						...
						<p>Navigate to <code>app.withops.io</code> and click <strong>"Get Started"</strong>. Sign up using your email address or authenticate directly with GitHub.</p>
					</div>
				</div>
				...
				<div class="step-card">
					...
					<div class="step-body">
						...
						<p>After account creation, you'll be prompted to connect your GitHub account. Click <strong>"Connect GitHub"</strong> and authorise the WithOps GitHub App. Select which repositories to grant access to.</p>
					</div>
				</div>
				...
				<div class="step-card">
					...
					<div class="step-body">
						...
						<p>Choose a repository to create your first workspace. WithOps will automatically analyse its structure, dependencies, and security posture.</p>
					</div>
				</div>
				...
				<div class="step-card">
					...
					<div class="step-body">
						...
						<p>Navigate to the <strong>Security</strong> tab and click <strong>"Run Full Scan"</strong>. The AI-powered analysis will complete within 30–90 seconds depending on repository size.</p>
					</div>
				</div>
			</div>

			<p class="prose-text">That's it — you're ready to explore your security dashboard. See <a href="/docs/getting-started/first-security-scan">First Security Scan</a> for a detailed walkthrough of scan results.</p>
		</div>
	{/if}
	...
	{#if activeTab === 'self'}
		<div class="tab-panel" id="self-hosted-setup">
			...
			<div class="code-block">
				...
				<pre><code><span class="cm"># Clone the WithOps platform</span>
<span class="fn">git</span> clone https://github.com/withops/platform.git
<span class="fn">cd</span> platform</code></pre>
			</div>
			...
			<div class="code-block">
				...
				<pre><code><span class="cm"># ─── Authentication (Auth0) ───</span>
...
<span class="kw">SUPABASE_DATABASE_URL</span>=<span class="str">postgresql://postgres:[password]@aws-0-ap-south-1.pooler.supabase.com:5432/postgres</span>
...
<span class="kw">GROQ_API_KEY</span>=<span class="str">gsk_your_groq_key</span></code></pre>
			</div>
			...
			<div class="callout warn">
				...
				<div class="callout-content">
					...
					<p>Never commit <code>.env</code> to version control. The file is already included in <code>.gitignore</code>.</p>
				</div>
			</div>
			...
			<div class="code-block">
				...
				<pre><code><span class="cm"># Start all 9 microservices + infrastructure</span>
...
<span class="fn">docker</span> compose ps</code></pre>
			</div>
			...
			<div class="callout tip">
				...
				<div class="callout-content">
					...
					<p>If a service shows as unhealthy, check its container logs with <code>docker compose logs &lt;service-name&gt;</code>. Common issues include missing environment variables and port conflicts.</p>
				</div>
			</div>
		</div>
	{/if}
	...
	<p class="prose-text">
		After your platform is running (cloud or self-hosted), complete these one-time configuration steps.
	</p>
	...
	<div class="config-grid">
		<div class="config-item">
			...
			<div>
				...
				<p>Add your name, avatar, and notification preferences in <strong>Settings → Profile</strong>.</p>
			</div>
		</div>
		<div class="config-item">
			<div class="config-icon">
			...
			<div>
				...
				<p>Choose default scan types (SAST, Dependencies, Secrets, STRIDE) in <strong>Settings → Security</strong>.</p>
			</div>
		</div>
		<div class="config-item">
			<div class="config-icon">
			...
			<div>
				...
				<p>Set up email or Slack alerts for critical vulnerabilities in <strong>Settings → Notifications</strong>.</p>
			</div>
		</div>
	</div>
...
<style>
	...
	.prose-text a { color: var(--accent); text-decoration: none; }
	.prose-text a:hover { text-decoration: underline; }
	.prose-text code {
		font-family: 'DM Mono', monospace;
		font-size: 12px;
		background: var(--bg-surface-2);
	...
	@media (max-width: 768px) {
		...
		.health-name { width: auto; }
		.health-url { display: none; }
	}
</style>
