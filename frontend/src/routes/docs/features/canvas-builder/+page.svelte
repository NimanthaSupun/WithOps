...
<svelte:head>
	<title>Canvas Builder — WithOps Documentation</title>
</svelte:head>
...
<div class="getting-started {visible ? 'visible' : ''}">
	<div class="breadcrumb">
		...
		<span class="bc-sep">/</span>
		<span class="bc-current">Canvas Builder</span>
	</div>
	...
	<h1 class="page-title" id="canvas-builder">Canvas Builder</h1>
	<p class="page-subtitle">
		Visual CI/CD Workflow Engineering and YAML Automation.
	</p>

	<hr class="divider" />

	<div class="prose">
		<h2 id="overview" class="section-heading">What is the Canvas Builder?</h2>
		<p>
			<strong>Canvas Builder</strong> is a visual orchestrator for your CI/CD pipelines. It turns complex, abstract YAML code into a clear, visual map of your automation. Instead of wrestling with indentation, you can build your workflows using a drag-and-drop interface.
		</p>

		<h2 id="core-features" class="section-heading">Core Features</h2>
		<div class="capability-grid">
			<div class="capability-card">
				<h4>Visual Mapping</h4>
				<p>See your workflow triggers, active states, and file paths as interactive blocks.</p>
			</div>
			<div class="capability-card">
				<h4>Relationship Detection</h4>
				<p>Automatically maps connections between calling workflows and reusable workflows.</p>
			</div>
			<div class="capability-card">
				<h4>Action Library</h4>
				<p>Drag predefined, pre-vetted actions (Checkout, Setup, Build, etc.) directly into your workflow.</p>
			</div>
		</div>

		<h2 id="yaml-sync" class="section-heading">YAML Synchronization</h2>
		<p>
			The Canvas Builder is a true WYSIWYG editor. As you modify your visual design, it generates the corresponding GitHub Actions YAML in the background. Saving your design automatically triggers a Pull Request to your repository to update the actual code.
		</p>
		...
		<div class="callout tip">
			...
			<div class="callout-content">
				<div class="callout-label">Zero Syntax Errors</div>
				<p>The platform handles all the formatting and schema compliance, ensuring you never push a workflow that fails due to a missing space or typo.</p>
			</div>
		</div>
	</div>
