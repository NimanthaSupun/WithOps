...
<div class="getting-started {visible ? 'visible' : ''}">
	...
	<div class="prose">
		...
		<p>
			The simplest way to run WithOps locally is using **Docker Compose**. This spins up all 9
			microservices, the Kong Gateway, and the observability stack.
		</p>
		...
		<p>Never use plain text environment variables in production. Use a secure vault:</p>
		<ul>
		...
		<div class="callout warn">
			...
			<div class="callout-content">
				...
				<p>
					Ensure SSL termination at Kong Gateway, enable RBAC in the Auth Service, and configure
					persistent volume backups for PostgreSQL and Qdrant.
				</p>
			</div>
		</div>
	</div>
