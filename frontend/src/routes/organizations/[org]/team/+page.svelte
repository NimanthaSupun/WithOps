	...
	<div class="page-header">
		...
		{#if organization}
			<div class="org-header">
				<img
					src={organization.avatar_url || '/default-org.png'}
		...
		<div class="team-content">
			...
			<section class="invite-section">
				...
				<p class="invite-note">
					...
					The invited user will see a notification when they log in with the same email address. Invitations
					expire after 7 days.
				</p>
			</section>
							...
							<div class="invitation-card">
								<div class="invitation-info">
									...
									<span class="invitation-meta">
										Invited by {invitation.invited_by_name} • {getTimeUntilExpiry(
						...
						{#each invitations.filter((i) => i.status !== 'pending') as invitation}
							<div class="history-item">
								...
								<span class="history-date"
									>{formatDate(invitation.accepted_at || invitation.created_at)}</span
								>
							</div>
						{/each}
					</div>
